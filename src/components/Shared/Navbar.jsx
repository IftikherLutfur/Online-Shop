...
const Navbar = () => {
    ...
    return (
       <div className="bg-black bg-opacity-85 fixed z-10 w-full text-white">
	...
	<form  onSubmit={handleSearch}  className="relative">
        ...
        <button className="absolute bg-orange-600 p-1 font-bold text-white left-36 top-[2px]">Search</button>
	</form>
</fieldset>
        </div>
